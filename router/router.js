...
router.get("/api/organiz?", AcceptanceController.getAcceptance)
...
router.get("/api/empl?", EmployeesController.getEmpl)
...
router.get("api/organiz?", ProductController.getProduct)
...
router.get("/api/tasks/empl", TasksController.getTasksEmpl)
router.get("/api/tasks/procesitem", TasksController.getTasksProcesitem)
